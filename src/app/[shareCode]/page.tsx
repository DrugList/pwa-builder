...
function FormView({ forms }: { forms: any[] }) {
  ...
  const form = forms[0]; // Show first form
    ...
    return (
      <Card className="max-w-lg mx-auto mt-8">
        <CardContent className="pt-6 text-center">
          ...
          <p className="text-muted-foreground">{form.successMsg}</p>
        </CardContent>
      </Card>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="text-center py-8">
        ...
        {app.description && (
          <p className="text-muted-foreground max-w-md mx-auto">{app.description}</p>
        )}
      </div>
